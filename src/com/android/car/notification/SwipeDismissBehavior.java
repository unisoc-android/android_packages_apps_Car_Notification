 ...
 *
 * <p> Forked from {@link android.support.design.behavior.SwipeDismissBehavior}.
 * Commit bed7de3603499da7577e50ae70c2369dca9d2a55.
 *
 * <p> The reason we fork an older version is because b/71848667 was introduced in the later version
 * that has not been fixed.
 *
 * <p> There is also a difference in ViewDragHelper.Callback.onViewPositionChanged(),
 * where in the original code, the alpha does not change when dragging towards the left/start.
 * In our version, the alpha changes on both directions.
 *
 * <p> The code is also formatted and migrated to AndroidX.
 */
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        private boolean shouldDismiss(View child, float xvel) {
            if (xvel != 0f) {
                boolean isRtl = ViewCompat.getLayoutDirection(child)
                ...
                int distance = child.getLeft() - mOriginalCapturedViewLeft;
                int thresholdDistance = Math.round(child.getWidth() * mDragDismissThreshold);
    ...
    private class SettleRunnable implements Runnable {
        ...
        final private boolean mDismiss;
