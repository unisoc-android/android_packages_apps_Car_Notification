 ...
 *
 * Forked from com.android.systemui.statusbar.notification.ImageGradientColorizer.
 * It is an exact copy of the original class except for some code formatting.
 */
class ImageGradientColorizer {
    ...
    private ImageGradientColorizer() {}

    static Bitmap colorize(Drawable drawable, int backgroundColor, boolean isRtl) {
